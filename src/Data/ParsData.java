...
import AllException.DataException;
import AllException.DateException;
import AllException.SexException;
        ...
        for (String i : data) {
            if (i.length() == 1) {
                if (i.equals("f") || i.equals("m")) {
                    ...
                    } catch (SexException exception) {
                        exception.sexException(i);
                    }
                }
